...
--> MANAGING BACKEND AND FRONTEND IN DOCKER 
        Launch:
            It builds the Backend Container (installing heavy ML libs).
            It builds the Frontend Container (installing light UI libs).

            It creates a private network app-network.

            Live: The User types the EC2 Public IP (http://35.123.45.67:8501) and sees the app.
